<div class="commercial-policy-form bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
    <form wire:submit="saveCommercialPolicy">
        ...
        <div class="w-full relative" x-data="{ active: @json($isActive) }">
            <div class="accordion w-full relative" x-data="{ id: 1 }">
                ...
                <div class="mt-8 w-full relative" x-show="active === id" x-collapse>
                    @include('livewire.product.commercialpolicy')
                </div>
            </div>
        </div>
    </form>
