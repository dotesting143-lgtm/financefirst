<div class="pension-form bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
    <form>
            ...
            <div class="accordion w-full relative" x-data="{ id: 1 }">
                <div class="grid grid-cols-2 lg:grid-cols-6 gap-4 lg:gap-6 bg-oxford-blue text-white rounded-md py-3 px-4 lg:px-7 !pe-16 items-center relative">
                    ...
                    <div class="col-span-full sm:col-span-1">
                        ...
                        @error('internal_status') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
                    </div>
                    <div class="col-span-full sm:col-span-1">
                        ...
                        @error('uw_status') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
                    </div>
                ...
                <div class="mt-8 w-full relative" x-show="active === id" x-collapse>
                    @include('livewire.product.pensionpolicy')
                </div>
            </div>
        </div>
    </form>
