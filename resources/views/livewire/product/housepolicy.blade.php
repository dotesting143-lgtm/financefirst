...
<div class="grid grid-cols-1 gap-4 lg:gap-6 sm:grid-cols-6">
    ...
    <div class="sm:col-span-2">
  	...
  	<div class="sm:col-span-2">
        <label for="buildtype" class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Building Type') }}</label>
        <select id="buildtype" wire:model="buildtype" class="block text-xs lg:text-sm font-medium appearance-none border border-pale-blue-gray rounded-md w-full p-2.5 lg:p-3 text-black focus:outline-none focus:shadow-outline focus:border-oxford-blue focus:ring-oxford-blue placeholder:text-cool-gray">
          	<option selected value="">{{ __('Select Building') }}</option>
        ...
        @error('buildtype') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
    </div>
    <div class="sm:col-span-2">
        <label for="buildcost" class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Building Costs') }}</label>
        <input type="text" class="block text-xs lg:text-sm font-medium appearance-none border border-pale-blue-gray rounded-md w-full p-2.5 lg:p-3 text-black focus:outline-none focus:shadow-outline focus:border-oxford-blue focus:ring-oxford-blue placeholder:text-cool-gray" id="buildcost"  wire:model="buildcost">
        @error('buildcost') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
    </div>
    <div class="sm:col-span-2">
        <label for="contcost" class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Contents Value') }}</label>
        <input type="text" class="block text-xs lg:text-sm font-medium appearance-none border border-pale-blue-gray rounded-md w-full p-2.5 lg:p-3 text-black focus:outline-none focus:shadow-outline focus:border-oxford-blue focus:ring-oxford-blue placeholder:text-cool-gray" id="contcost"  wire:model="contcost">
        @error('contcost') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
    </div>
    <div class="sm:col-span-2">
    ...
    <div class="sm:col-span-2">
      	<label class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Smoke Alarm') }}</label>
      	<div class="flex py-2.5 flex-wrap justify-between gap-2 flex-col sm:flex-row">
          	<div class="flex items-center">
              	<input checked="" id="smokealarm1-yes" wire:model="smokealarm1" name="smokealarm1" type="radio" value="1" class="w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6 text-vivid-sky-blue bg-white border-neutral-gray focus:ring-vivid-sky-blue focus:ring-2">
              	<label for="smokealarm1-yes" class="ms-2 text-xs lg:text-sm font-medium text-cool-gray">Yes</label>
          	</div>
          	<div class="flex items-center">
              	<input id="smokealarm1-no" wire:model="smokealarm1" name="smokealarm1" type="radio" value="0" class="w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6 text-vivid-sky-blue bg-white border-neutral-gray focus:ring-vivid-sky-blue focus:ring-2">
              	<label for="smokealarm1-no" class="ms-2 text-xs lg:text-sm font-medium text-cool-gray">No</label>
          	</div>
      	</div>
      	@error('smokealarm1') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
  	</div>
  	<div class="sm:col-span-2">
      	<label class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Approved House') }}</label>
      	<div class="flex py-2.5 flex-wrap justify-between gap-2 flex-col sm:flex-row">
          	<div class="flex items-center">
              	<input checked="" id="approved1-yes" wire:model="approved1" name="approved1" type="radio" value="1" class="w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6 text-vivid-sky-blue bg-white border-neutral-gray focus:ring-vivid-sky-blue focus:ring-2">
              	<label for="approved1-yes" class="ms-2 text-xs lg:text-sm font-medium text-cool-gray">Yes</label>
          	</div>
          	<div class="flex items-center">
              	<input id="approved1-no" wire:model="approved1" name="approved1" type="radio" value="0" class="w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6 text-vivid-sky-blue bg-white border-neutral-gray focus:ring-vivid-sky-blue focus:ring-2">
              	<label for="approved1-no" class="ms-2 text-xs lg:text-sm font-medium text-cool-gray">No</label>
          	</div>
      	</div>
      	@error('approved1') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
  	</div>
  	<div class="sm:col-span-2">
        <label for="locktypes" class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Lock Types') }}</label>
        <input type="text" class="block text-xs lg:text-sm font-medium appearance-none border border-pale-blue-gray rounded-md w-full p-2.5 lg:p-3 text-black focus:outline-none focus:shadow-outline focus:border-oxford-blue focus:ring-oxford-blue placeholder:text-cool-gray" id="locktypes"  wire:model="locktypes">
        @error('locktypes') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
    </div>
    <div class="sm:col-span-2">
        <label for="conyear" class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Construction Year') }}</label>
        <input type="text" class="block text-xs lg:text-sm font-medium appearance-none border border-pale-blue-gray rounded-md w-full p-2.5 lg:p-3 text-black focus:outline-none focus:shadow-outline focus:border-oxford-blue focus:ring-oxford-blue placeholder:text-cool-gray" id="conyear"  wire:model="conyear">
        @error('conyear') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
    </div>
    <div class="sm:col-span-2">
        <label for="contype" class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Construction Type') }}</label>
        <select id="contype" wire:model="contype" class="block text-xs lg:text-sm font-medium appearance-none border border-pale-blue-gray rounded-md w-full p-2.5 lg:p-3 text-black focus:outline-none focus:shadow-outline focus:border-oxford-blue focus:ring-oxford-blue placeholder:text-cool-gray">
          	<option selected value="">{{ __('Select Construction Type') }}</option>
          	<option value="Standard">{{ __('Standard') }}</option>
		    <option value="Non-Standard">{{ __('Non-Standard') }}</option>
        </select>
        @error('contype') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
    </div>
    <div class="sm:col-span-2">
        <label for="flatroof" class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Flat Roof Percentage') }}</label>
        <input type="text" class="block text-xs lg:text-sm font-medium appearance-none border border-pale-blue-gray rounded-md w-full p-2.5 lg:p-3 text-black focus:outline-none focus:shadow-outline focus:border-oxford-blue focus:ring-oxford-blue placeholder:text-cool-gray" id="flatroof"  wire:model="flatroof">
        @error('flatroof') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
    </div>
    <div class="sm:col-span-2">
    ...
    <div class="sm:col-span-2">
      	<label class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Building Usage') }}</label>
      	<div class="flex py-2.5 flex-wrap justify-between gap-2 flex-col sm:flex-row">
          	<div class="flex items-center">
              	<input checked="" id="housetype1-pth" wire:model="housetype1" name="housetype1" type="radio" value="1" class="w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6 text-vivid-sky-blue bg-white border-neutral-gray focus:ring-vivid-sky-blue focus:ring-2">
              	<label for="housetype1-pth" class="ms-2 text-xs lg:text-sm font-medium text-cool-gray">PTH</label>
          	</div>
          	<div class="flex items-center">
              	<input id="housetype1-rip" wire:model="housetype1" name="housetype1" type="radio" value="0" class="w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6 text-vivid-sky-blue bg-white border-neutral-gray focus:ring-vivid-sky-blue focus:ring-2">
              	<label for="housetype1-rip" class="ms-2 text-xs lg:text-sm font-medium text-cool-gray">RIP</label>
          	</div>
          	<div class="flex items-center">
              	<input id="housetype1-home" wire:model="housetype1" name="housetype1" type="radio" value="0" class="w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6 text-vivid-sky-blue bg-white border-neutral-gray focus:ring-vivid-sky-blue focus:ring-2">
              	<label for="housetype1-home" class="ms-2 text-xs lg:text-sm font-medium text-cool-gray">Holiday Home</label>
          	</div>
      	</div>
      	@error('housetype1') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
  	</div>
  	<div class="sm:col-span-2">
        <label for="tenants" class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('No of Tenants') }}</label>
        <input type="text" class="block text-xs lg:text-sm font-medium appearance-none border border-pale-blue-gray rounded-md w-full p-2.5 lg:p-3 text-black focus:outline-none focus:shadow-outline focus:border-oxford-blue focus:ring-oxford-blue placeholder:text-cool-gray" id="tenants"  wire:model="tenants">
        @error('tenants') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
    </div>
    <div class="sm:col-span-2">
        <label for="lettype" class="block oxford-blue text-xs lg:text-sm font-medium mb-1 lg:mb-2">{{ __('Let Type') }}</label>
        <select id="lettype" wire:model="lettype" class="block text-xs lg:text-sm font-medium appearance-none border border-pale-blue-gray rounded-md w-full p-2.5 lg:p-3 text-black focus:outline-none focus:shadow-outline focus:border-oxford-blue focus:ring-oxford-blue placeholder:text-cool-gray">
          	<option selected value="">{{ __('Select Let Type') }}</option>
          	<option value="Family">{{ __('Family') }}</option>
		    <option value="Multi">{{ __('Multi') }}</option>
        </select>
        @error('lettype') <span class="text-red-500 block text-xs lg:text-sm mt-1">{{ $message }}</span>@enderror
    </div>
    <div class="sm:col-span-2">
