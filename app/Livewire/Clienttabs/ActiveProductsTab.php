...
class ActiveProductsTab extends Component
{
    public $client_id;
    public $policies;

    protected $listeners = ['refreshActiveProducts' => 'refreshPolicies'];
    ...
    public function refreshPolicies()
    {
        $this->fetchPolicies();
    }
    ...
    {
        return view('livewire.clienttabs.active-products-tab');
    }
}
